    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-950 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-gray-400">Sign in to your PromptVault Pro account</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-800 bg-gray-900 p-8 shadow-2xl">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-700 bg-gray-800 px-4 py-2.5 text-sm font-medium text-gray-200 hover:bg-gray-750 hover:border-gray-600 transition-colors"
          >
            <GoogleIcon />
